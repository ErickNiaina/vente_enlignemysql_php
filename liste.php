  ...
  ?>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading"><strong><?php echo $tous[$i]->getlibelle().'<br>';?></strong></div>
        <div class="panel-body"><img  src="IMAGE/<?php echo $tous[$i]->getimage();?>"></div>
        <div class="panel-footer">

            <b><?php echo "Crée par : ". $tous[$i]->getnom().'<br>';?></b>
            <b><?php echo $tous[$i]->getlibelle().'<br>';?></b>
            <b><?php echo $tous[$i]->getid().'<br>';?></b>
            <b><?php echo $tous[$i]->getprix().'<br>';?></b>
            <b><a href="detail.php?un=<?php echo $tous[$i]->getid();?> "><?php echo $tous[$i]->getmarque().'<br>';?></a></b>
            <b><?php echo $tous[$i]->getdescription().'<br>';?></b><br>
